    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"> Opération sur Paquet </h6>
                        </div>
                        <div class="card-body"><?php //echo ("Modele:" .$_SESSION['model']."  / Of:".$_SESSION['of_num']. "  /Paquet:  " .$_SESSION['pack_num']);?>
...
<!-- CODE PHP POUR RECUPERER LA GAMME -->
            ...
            //tab paquet
            $query = "SELECT DISTINCT pack_num FROM `p4_pack_operation` ORDER BY `p4_pack_operation`.`cur_date` ASC";
            $rsl= $con->query($query);
            $p2_packet_all = [];
            while ($item = $rsl->fetch_assoc())
            {
                $p4_pack_operation_all[] = $item;
            }
            $query1 = "SELECT * FROM `p4_pack_operation`";
            ...
            for($i=0; $i<count($p4_pack_operation); $i++){
                //if ($p4_pack_operation[$i]['pack_num']=$_SESSION['pack_num']){ ?>
                <tr>
                <td ><?php echo $p4_pack_operation[$i]['operation_code'];?></a></td>
                <td> <?php echo $p4_pack_operation[$i]['designation'] ;?></a></td>
                <td> <?php echo $p4_pack_operation[$i]['unit_time'];?></td>
                <td><?php echo $p4_pack_operation[$i]['pack_qte'];?> </td>
                <td> <?php echo $p4_pack_operation[$i]['prod_line'];?></td>
                <td> <?php echo $p4_pack_operation[$i]['digitex'];?></td>
                <td><?php echo $p4_pack_operation[$i]['cur_date'];?> </td>
                <td> <?php echo $p4_pack_operation[$i]['cur_time'];}?></td>
                </tr>
            </tbody>
            <tfoot>
            <tr>
