    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"> Paquet </h6>
                        </div>
                        <div class="card-body"><?php //echo ("Modele:" .$_SESSION['model']."  / Of:".$_SESSION['of_num']. "  /Paquets: ");?>
...
<!-- CODE PHP POUR RECUPERER LA GAMME -->
            ...
            //tab paquet
            $query1 = "SELECT `model`,`of_num`,`pack_num`,`prod_line`,`color`,`qte` FROM `p2_packet`";
            ...
            //echo "Ordre de Fabrication de référence " . $_SESSION['of'] ;
            $cq=0;

            foreach($p2_packet as $pack){
                //if ($pack['of_num']==$_SESSION['of_num']){ ?>
                <tr>
                <td ><a href='packop.php'><?php echo $pack['pack_num'];
                $_SESSION['pack_num']=$pack['pack_num']?></a></td>

                <td> <a href='gamme.php'><?php echo $pack['model'] ;?></a></td>
                <td> <?php echo $pack['prod_line'];?></td>
                <td><?php echo $pack['color'];?> </td>
                <td> <?php echo $pack['qte'];}?></td>
                </tr>
            </tbody>
            <tfoot>
            <tr>
