    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Ressource Humaine & Gestion des personnels </h6>
                        </div>
                        <div class="card-body">
            ...
            <tbody>
                ...
                $sql="SELECT DISTINCT i2_operator.reg_num,`i2_operator`.`full_name`,`i2_operator`.`card_id`,`prod_line`, `presence`, `downtime`, `performance`, `cur_date` 
                    FROM `p7_op_performance` 
                    RIGHT JOIN i2_operator ON p7_op_performance.`operator_reg_num` = i2_operator.reg_num; ";
                ...
                for ($i=0; $i<count($pres); $i++){?>
                    <tr>
                <td><?php echo ($pres[$i]['reg_num']);?></td>
                <td><?php echo ($pres[$i]['full_name']);?></td>
                <td><?php echo ($pres[$i]['card_id']);?></td>
                <td><?php echo ($pres[$i]['prod_line']);?></td>
                <td><?php echo ($pres[$i]['presence']);?></td>
                <td><?php echo ($pres[$i]['downtime']);?></td>
