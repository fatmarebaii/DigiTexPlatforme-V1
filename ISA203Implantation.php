...
<div class="row">
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
                        ...
                        <div class="dropdown">
          <button class="btn btn-primary dropdown-toggle" type="button" id="deroulantb" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">ISA203</button>
          <div class="dropdown-menu" aria-labelledby="deroulantb">
            ...
            <tbody>
                ...
                $sql="SELECT * FROM `p5_presence` WHERE `prod_line` LIKE '%ISA203%' ORDER BY `p5_presence`.`operator_reg_num` ASC; ";
